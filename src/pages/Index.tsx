...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-50 via-pink-50 to-violet-50 p-4">
      <div className="w-full max-w-md p-8 bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg border border-purple-100 animate-fade-in text-center">
        ...
        <Button 
          ...
          className="w-full py-6 bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
        >
      ...
      <p className="mt-8 text-sm text-purple-500">
        Designed with premium animations and modern UI principles
      </p>
    </div>
  );
};
